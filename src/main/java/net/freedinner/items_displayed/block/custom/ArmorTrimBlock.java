...
public class ArmorTrimBlock extends AbstractItemBlock implements SimpleWaterloggedBlock {
    ...
    private static final MapCodec<? extends HorizontalDirectionalBlock> CODEC = AbstractItemBlock.simpleCodec(ArmorTrimBlock::new);

    public ArmorTrimBlock(Properties settings) {
        super(settings);
    }
